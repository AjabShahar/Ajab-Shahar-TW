...
public class ReflectionSummaryRepresentation {
    ...
    public ReflectionSummaryRepresentation(long id, String title, PersonSummaryRepresentation speaker, Boolean published, String youtubeVideoId, String soundCloudId, Set<ReflectionTranscript> reflectionTranscripts, String thumbnailUrl) {
        this.id = id;
        this.title = title;
    ...
    public static ReflectionSummaryRepresentation createFrom(Reflection reflection){
        if(reflection != null){
            return new ReflectionSummaryRepresentation(reflection.getId(),reflection.getTitle(),PersonSummaryRepresentation.createFrom(reflection.getSpeaker()),reflection.getIsAuthoringComplete(), reflection.getYoutubeVideo(), reflection.getSoundCloudId(), reflection.getReflectionTranscripts(), reflection.getThumbnailURL() );
        }
        return null;
    }
}
