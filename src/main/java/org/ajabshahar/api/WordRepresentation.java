...
public class WordRepresentation {
    ...
    public WordRepresentation(int id, String originalWord, String wordTranslation, String wordTransliteration, String wordIntroSummaryOriginal, String wordIntroSummaryTranslation, String wordIntroSummaryTransliteration) {
        this.id = id;
