          ...
          if(value.category=='Songs'){
              return memo+
                  ...
                  ' on-close="onClose(\'oid'+index+'\')" closeButton="true">'+
                      '<song-introduction singer="'+details[index].singer+'" name="'+details[index].name+'" url="'+details[index].youtubeVideoId+'" open-video="isClosed(\'oid'+index+'\')"></song-introduction>'+
                  '</pop-up>';
          }
          return memo;
      },'');
