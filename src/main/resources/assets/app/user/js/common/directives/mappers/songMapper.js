...
thumbnailModule.directive("songMapper", function(nameService) {
    return {
        ...
        controller:function($scope){
            $scope.song = {"id":"song_"+$scope.details.id, "customStyle":$scope.customStyle,"imgSrc":$scope.details.thumbnail_url,"videoId":$scope.details.youtubeVideoId,"englishTransliteration":$scope.details.songTitle.englishTransliteration,
